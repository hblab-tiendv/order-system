...
public class CustomerAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.ordering.system.messagemodel.CustomerAvroModel.Builder newBuilder() {
    return new com.ordering.system.messagemodel.CustomerAvroModel.Builder();
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static com.ordering.system.messagemodel.CustomerAvroModel.Builder newBuilder(com.ordering.system.messagemodel.CustomerAvroModel.Builder other) {
    if (other == null) {
      return new com.ordering.system.messagemodel.CustomerAvroModel.Builder();
    } else {
      return new com.ordering.system.messagemodel.CustomerAvroModel.Builder(other);
    }
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static com.ordering.system.messagemodel.CustomerAvroModel.Builder newBuilder(com.ordering.system.messagemodel.CustomerAvroModel other) {
    if (other == null) {
      return new com.ordering.system.messagemodel.CustomerAvroModel.Builder();
    } else {
      return new com.ordering.system.messagemodel.CustomerAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ordering.system.messagemodel.CustomerAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ordering.system.messagemodel.CustomerAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ordering.system.messagemodel.CustomerAvroModel.Builder setId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ordering.system.messagemodel.CustomerAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ordering.system.messagemodel.CustomerAvroModel.Builder setUsername(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ordering.system.messagemodel.CustomerAvroModel.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ordering.system.messagemodel.CustomerAvroModel.Builder setFirstName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ordering.system.messagemodel.CustomerAvroModel.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ordering.system.messagemodel.CustomerAvroModel.Builder setLastName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ordering.system.messagemodel.CustomerAvroModel.Builder clearLastName() {
      lastName = null;
